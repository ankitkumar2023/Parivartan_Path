...
import { submitContact } from "../services/apiService.js";
...
export default function ContactPage() {
  ...
  const canSubmit =
    !errors.name && !errors.email && !errors.message && !status.loading;
   ...
   * Sends data to backend API which handles:
   * 1. Saving contact to database
   * 2. Sending 2 emails (admin notification + user confirmation)
   */
          ...
          >
            <div className="rounded-3xl bg-white dark:bg-slate-800 p-6 shadow-soft ring-1 ring-black/5 dark:ring-slate-700 md:p-8">
              ...
              <p className="mt-2 text-sm leading-6 text-gray-600 dark:text-slate-300">
                We typically respond within 24 hours. Your message remains
                confidential.
              </p>
                ...
                <div className="flex items-start gap-3 rounded-2xl bg-blue-50 dark:bg-slate-700/50 px-4 py-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-gray-600 dark:text-slate-300">
                      Recovery Avenue, Wellness District
                    </p>
                  </div>
                </div>
                ...
                <div className="grid h-56 place-items-center bg-gradient-to-br from-blue-900/10 dark:from-slate-700 via-white dark:via-slate-800 to-emerald-500/10 dark:to-slate-700">
                  <p className="px-6 text-center text-sm text-gray-700 dark:text-slate-300">
                    ...
                    <span className="block text-xs text-gray-500">
                      (We’ll add the iframe + location pin once you provide the
                      address.)
                    </span>
                  </p>
                </div>
